...
public static class MatchErrors
{
    ...
    public static readonly Error PlayerAlreadyInSession = Error.Conflict("mm.already_in_session", "Player already in an active session.");
    public static readonly Error PlayerNotHealthy = Error.Conflict("mm.not_healthy", "Player connection not healthy.");
}
