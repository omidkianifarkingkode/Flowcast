// MessageBits.cs
namespace Shared.Application.Realtime.Routing;
...
public static class MessageBits
{
    ...
    // Masks
    public const ushort DOMAIN_MASK = (1 << DOMAIN_BITS) - 1 << SHIFT_DOMAIN; // 0xFC00
    public const ushort VER_MASK =    (1 << VER_BITS)    - 1 << SHIFT_VER;    // 0x0300
    public const ushort DIR_MASK =    (1 << DIR_BITS)    - 1 << SHIFT_DIR;    // 0x0080
    public const ushort CODE_MASK =   (1 << CODE_BITS)   - 1 << SHIFT_CODE;   // 0x007F
