...
public sealed class IdentityEntity
{
    ...
    public static IdentityEntity Create(Guid accountId, Guid deviceId, DateTime nowUtc) =>
        Create(Guid.NewGuid(), accountId, IdentityProvider.Device, deviceId.ToString(), nowUtc, true);
